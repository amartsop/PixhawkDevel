...
class Setpoint{
    ...
    private:
        ...
        constexpr static float w_upper_limit = 1; 
        constexpr static float w_lower_limit = -1;
        ...
        constexpr static float theta_upper_limit = 0.8;
        constexpr static float theta_lower_limit = -0.8;

        // Channel for pitch command
        constexpr static int8_t channel_theta = 3;
};
